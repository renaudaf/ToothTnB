...
third = Toothbrush.new(title: "Superbrush", description: "The best brush ever seen", price: 1000, status: "Available", address: 'les iles de la madeleine', user_id: User.first.id)
...
fourth = Toothbrush.new(title: "Bamboosh", description: "My favorite Bamboo toothbrush that I use for my mouth, my shoes and my toilet!!", price: 15, status: "Available", address: 'quebec city', user_id: User.first.id)
...
fifth = Toothbrush.new(title: "Weird Circular ToothBrush", description: "A bit big and weirdly shaped but it gets the job done", price: 2, status: "Available", address: 'quebec city', user_id: User.first.id)
...
six = Toothbrush.new(title: "Like new, never used", description: "Bought it yesterday, but found my old one... Don't need it anymore", price: 25, status: "Available", address: "Charlotte, North Carolina, États-Unis d'Amérique", user_id: User.first.id)
